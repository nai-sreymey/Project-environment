...
const Login: React.FC = () => {
  ...
  const inputClass = (field: keyof FormState) =>
    `w-full px-4 py-2 rounded-md bg-gray-100 text-gray-900 focus:outline-none border transition-colors ${
      errors[field] ? "border-red-500" : "border-transparent"
  ...
  return (
    ...
    >
      <div className="bg-black bg-opacity-30 p-12 rounded-xl shadow-md w-full max-w-sm">
        <h2 className="text-3xl font-semibold text-white text-center mb-6">Login</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-green-500 text-white py-2 rounded-md font-semibold hover:bg-green-600 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {loading ? (
